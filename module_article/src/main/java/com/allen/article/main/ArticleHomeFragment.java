package com.allen.article.main;
...
import com.allen.article.adapter.HomeAdapter;
import com.allen.article.article.ArticlePresenter;
import com.allen.article.article.ArticleView;
 ...
 * </pre>
 */
@Route(path = ARouterPath.moduleArticleHomeFragmentPath)
public class ArticleHomeFragment extends BaseMvpFragment<ArticlePresenter> implements ArticleView, BaseQuickAdapter.RequestLoadMoreListener, BaseQuickAdapter.OnItemClickListener, BGABanner.Delegate, BaseQuickAdapter.OnItemChildClickListener, View.OnClickListener {
    ...
    private RelativeLayout mTitleBgRl;
    ...
    public int bindLayout() {
        return R.layout.module_article_fragment_home;
    }
    ...
    public void initView(View view) {
        ...
        mTitleBgRl = (RelativeLayout) view.findViewById(R.id.title_bg_rl);
    }
    ...
    private void setColorChange(float alpha) {
        mTitleTv.setTextColor(Color.argb((int) (alpha * 255), 255, 255, 255));
        mTitleBgRl.setBackgroundColor(Color.argb((int) (alpha * 255), 55, 154, 246));
        mStatusBarView.setBackgroundColor(Color.argb((int) (alpha * 255), 55, 154, 246));
        mSearchIv.setAlpha(alpha);
    }
    ...
    private View getBannerView() {
        View view = View.inflate(getActivity(), R.layout.module_article_adapter_item_header_banner, null);
